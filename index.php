...
<script type="text/javascript">
            ...
            Stripe.setPublishableKey('pk_test_mtDRb0AkNAwm95uf2E1wleiM');
...
<form action="" method="POST" id="payment-form" class="form-horizontal">
  ...
  <?php
require 'libs/Stripe.php';

$error = '';
$success = '';
	  
if ($_POST) {
  Stripe::setApiKey("sk_test_clYlsULIRQsOp0J1mEkbCc5K");
...
?>
  ...
  <fieldset>
    ...
    <div class="control-group">
      <div class="controls">
        <center>
          <button class="btn btn-success" type="submit">Pay $3,000</button>
        </center>
      </div>
    </div>
  </fieldset>
